...
public class PacketLive extends javax.swing.JFrame {
    ...
    String udpPacketExtraction(UDPPacket pac){
        ...
        String src_ip = String.valueOf( pac.src_ip);
        String dst_ip = String.valueOf( pac.dst_ip);
        String ident = String.valueOf( pac.ident);
        String version = String.valueOf( pac.version);
        String protocol = String.valueOf( pac.protocol);
        String offset = String.valueOf( pac.offset);
        String total_length = String.valueOf( pac.len);
        ...
        String data = new String(pac.data);
    ...
    String TCPPacketExtraction(TCPPacket pac){
        ...
        String data_string =  new String(pac.data);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if((index-1)>=0 && (index -1)<packets.size()){
            if(packets.get(index-1)  instanceof UDPPacket){
